<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        do {
            ...
            // Agregar un nuevo transporte a la base de datos
            $sql = "INSERT INTO transporte (idTransporte, nomTransporte, valor, idDestino) " . 
            ...
            $successMessage = "Transporte agregado correctamente";
